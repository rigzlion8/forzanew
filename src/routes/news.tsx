  ...
  head: () => ({
    meta: [
      { title: "News & Insights — Forza Security" },
      {
        name: "description",
        content:
          "Latest updates, community initiatives and security industry insights from Forza Security.",
      },
    ],
  }),
  component: News,
...
const posts = [
  ...
  },
  {
    ...
    excerpt:
      "Modernized vehicles equipped with advanced telematics now patrol additional regions across Kenya.",
  },
  {
    img: aboutCard,
    date: "Mar 2026",
...
function News() {
  return (
    <>
      <PageHero
        title="News & Insights"
        subtitle="What's happening at Forza Security and across the industry."
      />
      <Section>
        <div className="grid md:grid-cols-3 gap-8">
          {posts.map((p) => (
            <article key={p.title} className="group">
              ...
              <h3 className="font-display text-xl mt-2 group-hover:text-gold transition-colors">
                {p.title}
              </h3>
