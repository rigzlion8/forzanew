  ...
  head: () => ({
    meta: [
      { title: "Corporate Social Responsibility — Forza Security" },
      {
        name: "description",
        content:
          "Investing in the communities where we operate through education, environment, health and empowerment initiatives.",
      },
    ],
  }),
  component: CSR,
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Giving back to the communities that have given us so much."
      />
      <Section>
