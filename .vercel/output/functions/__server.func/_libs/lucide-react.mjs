...
const Dog = createLucideIcon("dog", __iconNode$o);
const __iconNode$n = [
...
const HandHeart = createLucideIcon("hand-heart", __iconNode$i);
const __iconNode$h = [
  [
    "path",
    {
...
const Satellite = createLucideIcon("satellite", __iconNode$7);
const __iconNode$6 = [
  [
    "path",
    {
