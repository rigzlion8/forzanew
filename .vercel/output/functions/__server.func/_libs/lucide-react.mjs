...
const Dog = createLucideIcon("dog", __iconNode$r);
const __iconNode$q = [
...
const HandHeart = createLucideIcon("hand-heart", __iconNode$l);
const __iconNode$k = [
  [
    "path",
    {
...
const Satellite = createLucideIcon("satellite", __iconNode$9);
const __iconNode$8 = [
  [
    "path",
    {
